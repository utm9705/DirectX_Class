...
public:
	...
	float Move(DWORD positive, DWORD negative);

	void MovePosition(IN OUT D3DXVECTOR3* position, float speed);
	void MovePosition(IN OUT D3DXVECTOR3* position, float speed, DWORD up, DWORD down, DWORD right, DWORD left);

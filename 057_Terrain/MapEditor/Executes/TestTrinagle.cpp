#include "stdafx.h"
#include "TestTrinagle.h"

void TestTrinagle::Initialize()
{
...
void TestTrinagle::Ready()
{
	
}

void TestTrinagle::Destroy()
{
	
}

void TestTrinagle::Update()
{
	D3DXMATRIX W;
...
void TestTrinagle::PreRender()
{

}

void TestTrinagle::Render()
{
